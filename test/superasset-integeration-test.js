...
const privateKey3 = new bsv.PrivateKey('wifkey3');
...
describe('SA10', () => {
   ...
   it('Deploy, Tranfer Multiple Times with Different Payloads (Same owner) and Melt', async () => {
      ...
      try {
         ...
         delete assetClone.txoutpoint;
         delete assetClone.assetCode;
         delete assetClone.assetCodeHex;
      ...
      try {
         ...
         delete assetClone.txid;
         delete assetClone.index;
         delete assetClone.meltedAssetCode;
         delete assetClone.meltedAssetCodeHex;
